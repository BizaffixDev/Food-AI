class Strings {
  ...
  static const appName = 'Moss Yoga';

  static const timeoutError = 'The connection has timed out, please try again.';
  static const conflictError = 'Conflict occurred';
  static const unauthorizedError = 'User session has expired';
  static const commonError = 'Something went wrong, please try again later';
  static const noInternetConnectionError =
      'Internet connection not detected, try again';
  ...
  static const errorInvalidEmailAddress = 'Error Invalid Email Address';
  static const errorPasswordRequired = 'Error Password Required';
  static const errorRequireText = 'Error Text Required';

  ///

  static const googlePlayURL ='';
  static const appStoreShareURL ='';


  //REGEX PATTERN

  static RegExp emailRegex = RegExp(r'^[\w-]+(\.[\w-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,})$');

  //static RegExp phoneRegex = RegExp(r'^\+\d{1,3}\s?\(\d{3}\)\s?\d{3}\-\d{4}$');

  //final RegExp _phoneRegex = RegExp(r'^\+\d{12}$');
  static RegExp phoneRegex = RegExp(r'^\+\d{11}$');
